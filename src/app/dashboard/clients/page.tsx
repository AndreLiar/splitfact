    ...
    <div className="container-fluid mt-4">
                    ...
                    {currentClients.map((client) => {
                      ...
                      return (
                        <div key={client.id} className="col-xl-4 col-lg-6 col-md-6 col-12 mb-3 mb-lg-4">
                          <div
                            className={`card h-100 shadow-sm border-0 hover-card client-card${highlightId === client.id ? ' border-warning border-2' : ''}`}
                            ...
                            <div className="card-body pt-0">
                              <div className="mb-3">
                                ...
                                <div className="progress client-progress" style={{ height: '4px' }}>
                                  <div
                                    className={`progress-bar ${completeness >= 80 ? 'bg-success' : completeness >= 50 ? 'bg-warning' : 'bg-danger'}`}
            ...
            <div className="modal-content border-0 shadow">
              <div className="modal-header border-0 pb-0">
                <div>
                  ...
                  <small className="text-muted">
                    {currentClient
                      ? 'Modifiez les informations utilisées dans vos factures'
                      : 'Ajoutez un client avec les données utiles à votre workflow de facturation'}
                  </small>
                </div>
      ...
      <style jsx>{`
        ...
        @media (max-width: 768px) {
          ...
          .client-card-label { font-size: 12px; }
          .client-card-value { font-size: 13px; }
          .client-progress { height: 6px !important; }
          .client-info-item {
            display: flex;
            align-items: center;
            margin-bottom: 8px;
          ...
          .client-actions { gap: 8px; }
        }

        @media (max-width: 375px) {
          .client-card { margin-bottom: 10px; }
          .client-info-text { font-size: 12px; }
          .mobile-touch-btn {
            min-height: 48px;
            font-size: 14px;
          }
